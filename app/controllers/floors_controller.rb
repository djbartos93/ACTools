class FloorsController < ApplicationController
  ...
  private
    ...
    def floor_params
      params.require(:floor).permit(:name, :image, :vfx, :diy, :buy, :sell, :color_1, :color_2, :source, :source_notes, :version, :hha_concept_1, :hha_concept_2, :hha_series, :tag, :catalog, :filename, :internal_id, :unieque_entry_id)
    end
end
